...
(async () => {
  ...
  for (const user of users) {
    ...
    await desktopPage.click('xpath=/html/body/div/footer/div/div[2]/div[3]/a');
    ...
    await desktopPage.getByRole('option', { name: 'BLS' }).click(); //*[@id="broker_login_username_input"] //*[@id="broker_login_username_input"]
     for (const borkers of borker) {
       await desktopPage.fill('xpath=//*[@id="broker_login_username_input"]', borkers.email);
       await desktopPage.fill('xpath=//*[@id="broker_login_password_input"]', borkers.password);
     }
    await desktopPage.click('xpath=//*[@id="broker_login_submit_btn"]'); 
    await desktopPage.click('xpath=/html/body/div[1]/div/main/div/div[2]/div[1]/div/div[4]/div/button[2]');
